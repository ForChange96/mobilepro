				...
				<td align="center">
					<table width="80%" border="0" cellspacing="0" cellpadding="5" style="border-top:1px solid #DEE3F1">
						<tr>
							...
							<td align="left" valign="bottom"><input type="text" name="username" class="form-control" style="width:200px; height: 28px;" value="{$smarty.post.username}"/></td>
						</tr>

						<tr>
							<td height="50" align="right"><span style="line-height: 28px;">Mật khẩu&nbsp;</span></td>
							<td align="left"><input type="password" name="password" class="form-control" style="width:200px; height: 28px;" value="{$smarty.post.password}"/></td>
						</tr>
                        {if $error}
							<tr>
