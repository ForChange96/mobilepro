<?php /* Smarty version 2.6.13, created on 2018-02-06 11:33:05
            ...
            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal" id="frm_edit_customer">
                <fieldset id="account">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="fullname" value="<?php echo $this->_tpl_vars['customer']['fullname']; ?>
" placeholder="Họ và tên:" id="input-fullname" class="form-control" required/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-address">Địa chỉ:</label>
                        <div class="col-sm-10">
                            <input type="text" name="address" value="<?php echo $this->_tpl_vars['customer']['address']; ?>
" placeholder="Địa chỉ:" id="input-address" class="form-control" required/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-telephone">Điện Thoại:</label>
                        <div class="col-sm-10">
                            <input type="tel" name="telephone" value="<?php echo $this->_tpl_vars['customer']['phone_number']; ?>
" placeholder="Điện Thoại:" id="input-telephone" class="form-control" required/>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <fieldset style="display: none" id="frm_change_password">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="password" name="old_password" placeholder="Mật Khẩu:" id="input-old-password" class="form-control" onchange="check_pass_for_change(<?php echo $_SESSION['customer']; ?>
)"/>
                        </div>
                    </div>
                    <div class="form-group">
