<?php /* Smarty version 2.6.13, created on 2018-02-21 09:16:42
         compiled from dang-ky.tpl */ ?>
<div class="container">
    <div class="row">
        <div id="content" class="col-sm-12 other_page">
            ...
            <div style="line-height:16px;margin-bottom: 20px;">
                ...
                <div style="padding: 5px 0 0 28px">Hoặc sử dụng tài khoản <a href="<?php echo $_SESSION['loginURL']; ?>
">Facebook</a> </div>
            </div>
