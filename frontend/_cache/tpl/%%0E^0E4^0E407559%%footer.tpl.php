<?php /* Smarty version 2.6.13, created on 2018-03-01 09:48:50
                                ...
                                <div class="col-sm-4 col-md-4 col-lg-4">
                                    <div class="single-slider-promo">
                                        ...
                                        <div class="s-p-text">
                                            ...
                                            <p>Đổi trả hàng nhanh chóng</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4 col-md-4 col-lg-4">
                                    <div class="single-slider-promo midexchange">
                                        <div class="s-p-icon">
                                            <a href="#">
                                        ...
                                        <div class="s-p-text">
                                            ...
                                            <p>Miễn phí vận chuyển trong khu vực</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4 col-md-4 col-lg-4">
                                    <div class="single-slider-promo border-none">
                                        <div class="s-p-icon">
                                            <a href="#">
                                        ...
                                        <div class="s-p-text">
                                            <a href="#">Giảm giá VIP</a>
                                            <p>VIP sẽ được giảm giá</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div class="h16-menu">
                                                        <nav>
                                                            <div class="left-cart-menu">
                                                                <ul>
                                                                    <li><i class="fa "></i> <a
                                                                                href="javascript:void(0)"> Thông Tin </a>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="warning-new text-center">
                                                        <div class="warning-new text-center"><!-- Not delete --></div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <form action="" method="post">
                                                        <div class="form-group newsletters-info">
                                                            <label class="col-sm-12 control-label title-newsletters">Đăng ký nhận tin</label>
                                                            <div class="col-sm-12">
